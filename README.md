...
-   Mike Hendrickson, Roger Magoulas, and Tim O’Reilly, *Economic Impact
    ...
    2012),
    http://oreilly.com/opensource/radarreports/economic-impact-of-open-source.html
-   Tore Dybå and Torgeir Dingsøyr, “Empirical Studies of Agile Software
...
-   Henrik Kniberg, *Lean from the Trenches: Managing Large-Scale
    Projects with Kanban* (The Pragmatic Bookshelf, 2011),
    http://pragprog.com/book/hklean/lean-from-the-trenches
-   Ferd T-Hebert, *Learn You Some Erlang for Great Good!* (No Starch
    Press, 2013), http://learnyousomeerlang.com/
-   Brian Foote and William F. Opdyke, “Life Cycle and Refactoring
    Patterns That Support Evolution and Reuse,” in *First Conference on
    Pattern Languages of Programs (PLoP’94* (Addison-Wesley, 1995),
    239–257
-   Harold Abelson and Gerald J. Sussman, “Lisp: A Language for
    Stratified Design,” *Byte* 13, no. 2 (1988): 207–218
-   Kyle Loudon, *Mastering Algorithms with C* (O’Reilly Media, 2009),
...
-   Tom Stuart, *Understanding Computation* (O’Reilly Media, 2013),
    http://shop.oreilly.com/product/0636920025481.do
-   Reg “Raganwald” Braithwaite, *What I’ve Learned From Failure: A
    Quarter-Century of Experience Shipping Software, Distilled into
    Fixnum Bittersweet Essays* (Leanpub, 2012),
    https://leanpub.com/shippingsoftware
-   Mike Loukides, *What Is DevOps?*, Velocity (O’Reilly Media, June
    2012),
    http://shop.oreilly.com/product/0636920026822.do?intcmp=il-velocity-books-what-is-devops-radar-edition
-   Drew Crawford, “Why Mobile Web Apps Are Slow,” *Sealed Abstract*,
    July 9, 2013,
    http://sealedabstract.com/rants/why-mobile-web-apps-are-slow/
-   Marius Eriksen, “Your Server As a Function,” in *Proceedings of the
    Seventh Workshop on Programming Languages and Operating Systems*,
    PLOS ’13 (New York, NY, USA: ACM, 2013), 5:1–5:7,
...
-   Andrew Pavlo et al., “A Comparison of Approaches to Large-Scale Data
    Analysis,” in *SIGMOD ’09: Proceedings of the 35th SIGMOD
    International Conference on Management of Data* (New York, NY, USA:
    ACM, 2009), 165–178, doi:http://doi.acm.org/10.1145/1559845.1559865
-   Eric Redmond, *A Little Riak Book*, 2013,
    http://littleriakbook.com/
-   Ben Yoskovitz and Alistair Croll, *Analytics Lessons Learned*, 2013,
    http://leananalyticsbook.com/analytics-lessons-learned-free-e-book-with-13-case-studies/
-   Harlan Harris, Sean Murphy, and Marck Vaisman, *Analyzing the
    Analyzers: An Introspective Survey of Data Scientists and Their
    Work* (O’Reilly, 2013),
...
-   DJ Patil, *Building Data Science Teams* (Radar, 2011),
    http://www.oreilly.com/data/free/building-data-science-teams.csp
-   Avinash Lakshman and Prashant Malik, “Cassandra: A Decentralized
    Structured Storage System,” *SIGOPS Oper. Syst. Rev.* 44, no. 2
    (April 2010): 35–40, doi:10.1145/1773912.1773922
-   Eben Hewitt, *Cassandra: The Definitive Guide* (O’Reilly Media,
    2010), http://shop.oreilly.com/product/0636920010852.do
-   John Russell, *Cloudera Impala* (O’Reilly, n.d.),
    http://www.oreilly.com/data/free/cloudera-impala.csp
-   Mihai Letia, Nuno M. Pregui\\cca, and Marc Shapiro, “CRDTs:
    Consistency without Concurrency Control,” *CoRR* abs/0907.0929
    (2009)
-   Michael Bostock, Vadim Ogievetsky, and Jeffrey Heer, “D3:
    Data-Driven Documents,” *IEEE Trans. Visualization & Comp. Graphics
    (Proc. InfoVis)* (2011), http://vis.stanford.edu/papers/d3
-   Alex Howard, *Data for the Public Good: Data Holds Immense Potential
    to Help Citizens and Government*, Strata (O’Reilly Media, February
    2012), http://shop.oreilly.com/product/0636920025580.do
-   DJ Patil, *Data Jujitsu*, Strata (O’Reilly, 2012),
    http://oreilly.com/data/radarreports/data-jujitsu.html
-   Mohammed Zaki and Wagner Jr. Meira, *Data Mining and Analysis:
    Fundamental Concepts and Algorithms*, Draft (Cambridge University
    Press, n.d.), http://dataminingbook.info/
-   Open Knowledge Foundation, *Data Wrangling Handbook*, 2013,
    http://schoolofdata.org/handbook/
-   Jeremy Howard, Margit Zwemer, and Mike Loukides, *Designing Great
    Data Products: Inside the Drivetrain Approach, a Four-Step Process
    for Building Data Products*, Strata (O’Reilly Media, March 2012),
    http://shop.oreilly.com/product/0636920026082.do
-   Jeffrey Needham, *Disruptive Possibilities: How Big Data Changes
    Everything* (O’Reilly Media, 2013),
    http://shop.oreilly.com/product/0636920029526.do
-   Sergey Melnik et al., “Dremel: Interactive Analysis of Web-Scale
    Datasets,” in *Proc. of the 36th Int’l Conf on Very Large Data
    Bases*, 2010, 330–339, http://www.vldb2010.org/accept.htm
-   Giuseppe DeCandia et al., “Dynamo: Amazon’s Highly Available
    Key-Value Store,” in *Proceedings of Twenty-First ACM SIGOPS
    Symposium on Operating Systems Principles*, SOSP ’07 (New York, NY,
    USA: ACM, 2007), 205–220, doi:10.1145/1294261.1294281
-   Ian Robinson, Jim Webber, and Emil Eifrem, *Graph Databases*
    (O’Reilly Media, 2013), http://graphdatabases.com/
-   Aapo Kyrola, Guy Blelloch, and Carlos Guestrin, “GraphChi:
    Large-Scale Graph Computation on Just a PC,” in *Proceedings of the
    10th USENIX Conference on Operating Systems Design and
    Implementation*, OSDI’12 (Berkeley, CA, USA: USENIX Association,
    2012), 31–46, http://dl.acm.org/citation.cfm?id=2387880.2387884
-   Tim O’Reilly et al., *How Data Science Is Transforming Health Care*,
    Strata (O’Reilly Media, August 2012),
    http://www.oreilly.com/data/free/how-data-science-is-transforming-health-care.csp
-   Scott Murray, *Interactive Data Visualization for the Web* (O’Reilly
    Media, 2013), http://chimera.labs.oreilly.com/books/1230000000345
-   Daniel Peng and Frank Dabek, “Large-Scale Incremental Processing
    Using Distributed Transactions and Notifications,” in *Proceedings
    of the 9th USENIX Symposium on Operating Systems Design and
    Implementation*, 2010
-   Alistair Croll and Benjamin Yoskovitz, *Lean Analytics: Use Data to
...
-   Jeffrey Dean and Sanjay Ghemawat, “MapReduce: Simplified Data
    ...
    on Symposium on Opearting Systems Design & Implementation - Volume
    6*, OSDI’04 (Berkeley, CA, USA: USENIX Association, 2004), 10–10,
...
-   Gregory Smith, *PostgreSQL 9.0 High Performance* (Packt Publishing,
    2010), http://www.packtpub.com/postgresql-90-high-performance/book
-   Gianpaolo Cugola and Alessandro Margara, “Processing Flows of
    Information: From Data Stream to Complex Event Processing,” *ACM
    Comput. Surv.* 44, no. 3 (June 2012): 15:1–15:62,
    doi:10.1145/2187671.2187677
-   Joseph M. Hellerstein, *Quantitative Data Cleaning for Large
    Databases*, 2008,
...
-   James, “Spanner: Google’s Globally-Distributed Database,” in
    *Proceedings of OSDI’12: Tenth Symposium on Operating System Design
    and Implementation* (Hollywood, CA, 2012),
    http://research.google.com/archive/spanner.html
-   Nathan Bronson et al., “TAO: Facebooks Distributed Data Store For
    The Social Graph,” in *Proceedingsof the USENIX Annual Tech- Nical
    Conference* (San Jose, California, 2013), 49–60,
    http://www.cs.cmu.edu/\~pavlo/courses/fall2013/static/papers/11730-atc13-bronson.pdf
-   Michael Stonebraker, Ugur Cetintemel, and Stan Zdonik, “The 8
    Requirements of Real-Time Stream Processing,” *ACM SIGMOD Record*
    34, no. 4 (December 2005): 42–47, doi:10.1145/1107499.1107504
-   Mike Barlow, *The Culture of Big Data* (O’Reilly, 2013),
    http://www.oreilly.com/data/free/culture-of-big-data.csp
...
-   Sanjay Ghemawat, Howard Gobioff, and Shun-Tak Leung, “The Google
    ...
    2003), 29–43, doi:10.1145/945445.945450
...
-   *The Open Data Handbook* (Open Knowledge Foundation, n.d.),
    http://opendatahandbook.org/
-   Hadley Wickham, *The Split-Apply-Combine Strategy for Data
    Analysis*, 2009
-   Matthias Broecheler, “Titan: Big Graph Data with Cassandra,” August
    8, 2012,
    http://www.slideshare.net/knowfrominfo/titan-big-graph-data-with-cassandra
-   Marko A. Rodriguez, “Titan: The Rise of Big Graph Data,” June 14,
    2012,
    http://www.slideshare.net/slidarko/titan-the-rise-of-big-graph-data
-   “Unicorn: A System for Searching the Social Graph,” *VLDB 2013
    Industrial Track* (n.d.)
...
-   Marty Cagan, *Inspired: How to Create Products Customers Love* (SVPG
    Press, 2008),
...
-   Marcin Treder, *UX Design for Startups* (UXPin, 2013),
    http://uxpin.com/ux-design-for-startups.html
-   William Addison Dwiggins, *WAD to RR: A Letter about Designing
    Type*, 1940, https://archive.org/details/WADtoRR1940
-   Awwwards, *Web Design and Mobile Trends for 2013*, 2013,
...
-   Bernice E. Rogowitz and Lloyd A. Treinish, *Why Should Engineers and
...
-   Tony Hsieh, *Delivering Happiness* (Business Pul, 2010),
...
-   Tim Jenkinson, Howard Jones, and Jose Vicente Martinez, *Picking
    Winners? Investment Consultants’ Recommendations of Fund Managers*,
...
-   Diane Mulcahy, Bill Weeks, and Harold Bradley, *We Have Met the
    Enemy…and He Is Us: Lessons from Twenty Years of the Kauffman
...
-   Dr William H. Janeway, “What I Learned by Doing Capitalism” (LSE
    ...
    11, 2012),
    http://www.lse.ac.uk/publicEvents/events/2012/10/20121011t1830vSZT.aspx
...
## Journalism, Publishing, and Content

-   Matt Garrish, *Accessible EPUB 3* (O’Reilly Media / Tools of Change,
    2012), http://shop.oreilly.com/product/0636920025283.do
-   O’Reilly Media, Inc., *Best of TOC, 3rd Edition: Analysis and Ideas
    About the Future of Publishing* (O’Reilly, February 2013),
    http://www.oreilly.com/toc/free/best-of-toc-3e.csp
-   Peter Meyers, *Breaking the Page: Preview Edition* (O’Reilly Media,
    2011), http://shop.oreilly.com/product/0636920020677.do
-   Karen McGrane, *Content Strategy for Mobile* (A Book Apart, 2012),
    https://readmill.com/books/content-strategy-for-mobile-1
-   Peter Armstrong, *Lean Publishing* (LeanPub, 2013),
    https://leanpub.com/lean
-   C\. W\. Anderson, Emily Bell, and Clay Shirky, *Post Industrial
    Journalism: Adapting to the Present* (New York: Tow Center for
    Digital Journalism, Columbia Journalism School, November 2012),
...
-   Cory Doctorow, “All Complex Ecosystems Have Parasites” (presented at
    the O’Reilly Emerging Technology Conference, San Diego, California,
    2005), http://craphound.com/complexecosystems.txt
...
-   Matthew J Salganik, Peter Sheridan Dodds, and Duncan J Watts,
    ...
    854–856
-   Paul Adams, *Grouped: How Small Groups of Friends Are the Key to
